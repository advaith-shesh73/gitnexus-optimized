 ...
 * All searchable/embeddable type lists are defined in searchable-types.ts.
 */
import { EMBEDDABLE_LABELS as _EMBEDDABLE_LABELS } from '../search/searchable-types.js';

export const EMBEDDABLE_LABELS = _EMBEDDABLE_LABELS;
