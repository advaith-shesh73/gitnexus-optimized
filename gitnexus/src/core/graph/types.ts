...
export type RelationshipType =
  ...
  | 'DECLARES'        // Header node → Implementation node (C/C++ .h declares what .cc defines)
  | 'DEFINED_BY'      // Implementation node → Header node (reverse of DECLARES)
  | 'PARTIAL_OF'      // C# partial class node → canonical partial (links split class definitions)
