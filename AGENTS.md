...
This project is indexed by GitNexus as **GitNexus** (3381 symbols, 7867 relationships, 245 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
